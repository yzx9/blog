/**
 * Refs: waylonflinn/markdown-it-katex, iktakahiro/markdown-it-katex
 *
 * CHNAGELOG:
 * - add v-pre tag
 */
...
export function math_plugin(md, options) {
  // Default options
  ...
  var inlineRenderer = function (tokens, idx) {
    return "<span v-pre>" + katexInline(tokens[idx].content) + "</span>"
  }
